...
export default function News({ category }) {
    ...
    return <div style={{ marginTop: "70px" }}>
        ...
        <hr />
        <InfiniteScroll className="panel row mx-3 py-2 gx-4" next={() => fetchData(category, true, 'new')} hasMore={!end} loader={progress > 0 && <Loader />} endMessage={news.length > 0 && <p className='text-center fw-bold'>Yay! You have seen it all</p>} dataLength={fullNews.length}>
