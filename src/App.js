      ...
      <div>
        <Router>
          ...
          <Routes>
            ...
            <Route path='/' element={<News country={this.state.country} category='' query={this.state.query} key={`${this.state.country}`} />} />
            <Route path='/business' element={<News country={this.state.country} category='Business' query={this.state.query} key={`${this.state.country}business`} />} />
            <Route path='/entertainment' element={<News country={this.state.country} category='Entertainment' query={this.state.query} key={`${this.state.country}entertainment`} />} />
            <Route path='health' element={<News country={this.state.country} category='Health' query={this.state.query} key={`${this.state.country}health`} />} />
            <Route path='science' element={<News country={this.state.country} category='Science' query={this.state.query} key={`${this.state.country}science`} />} />
            <Route path='sports' element={<News country={this.state.country} category='Sports' query={this.state.query} key={`${this.state.country}sports`} />} />
            <Route path='technology' element={<News country={this.state.country} category='Technology' query={this.state.query} key={`${this.state.country}technology`} />} />
          </Routes>
        </Router>
      </div>
    )
